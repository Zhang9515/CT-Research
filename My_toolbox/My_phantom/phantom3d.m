...
e = modified_shepp_logan;
e(:,1) = [ 2 -.98 -.02 -.02 .02 .02 .01 .01 .01 .01 .02 -.02 ];
...
%        -----------------------------------------------------
e =    [  1  .6900  .920  .900      0       0       0      0    
        -.8  .6624  .874  .880      0       0       0      0    
        -.2  .310  .1100  .220    .22      0      -.25     72    
        -.2  .410  .1600  .280   -.22       0     -.25    108     
         .2  .0460  .046  .046      0      .1     -.25     0     
         .2  .2100  .250  .500      0      .35    -.25     0     
         .1  .0460  .046  .046      0     -.1     -.25     0      
         .1  .0460  .023  .020   -.08    -.605    -.25     90    
         .1  .0230  .023  .020      0   -.606     -.25     90   
         .1  .0460  .023  .020    .06   -.605     -.25      0  
         .2  .0560  .040  .10    .06    -.105     .625      0
        -.2  .0560  .056  .10       0     .105    .625      0 ];
