function [p,ellipse]=StandardPhantom(varargin)
%StandardPhantom Create head phantom image.
...
% *****note: no underline in the space
...
function shep = Standard_shepp_logan
%
%  This is the default head phantom, taken from AK Jain, 439.
%
%         A    a     b    x0    y0    phi
